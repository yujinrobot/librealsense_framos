...
if (NOT APPLE)
    #[FRAMOS] Default set to OFF for FRAMOS package building reasons
    option(CHECK_FOR_UPDATES "Checks for versions updates" OFF) 
else()
    option(CHECK_FOR_UPDATES "Checks for versions updates" OFF) 
endif()
#[FRAMOS] Option added for Linux ARM 32 build
...
option(BUILD_FRAMOS_CODE "Build Framos extended code to support D400e devices." ON)
if (UNIX AND BUILD_FRAMOS_CODE)
    option(FRAMOS_DISABLE_LIBUSB "Disable libusb usage within the library" OFF)
endif()
