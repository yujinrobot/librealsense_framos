...
#include "rs_types.h"
    ...
    */
    typedef enum rs2_option
    {
        ...
        RS2_OPTION_SOFTWARE_TRIGGER_ALL_SENSORS, /**< Software trigger translated to all sensors*/
        RS2_OPTION_LINE_DEBOUNCER_TIME, /**< Line debouncer time (microseconds) for eth cameras*/
        RS2_OPTION_EXTERNAL_EVENT_BURST_COUNT, /** External Event burst count*/
        RS2_OPTION_RGB_LED_TOGGLE, /**Toggles the RGB camera LED light*/
        RS2_OPTION_METADATA_TOGGLE, /**Toggles the Metadata*/
        #endif
