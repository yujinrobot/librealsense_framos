...
namespace librealsense
{
    ...
    private:
        ...
        void get_color_auto_white_balance(auto_white_balance_control* ptr) const;
        void get_color_power_line_frequency(power_line_frequency_control* ptr) const;
        void get_depth_inter_packet_delay(depth_inter_packet_delay_control* ptr) const;
        void get_color_inter_packet_delay(color_inter_packet_delay_control* ptr) const;
        void get_depth_packet_size(depth_packet_size_control* ptr) const;
        void get_color_packet_size(color_packet_size_control* ptr) const;
        ...
        void set_color_auto_white_balance(const auto_white_balance_control& val);
        void set_color_power_line_frequency(const power_line_frequency_control& val);
        void set_depth_inter_packet_delay(const depth_inter_packet_delay_control& val);
        void set_color_inter_packet_delay(const color_inter_packet_delay_control& val);
        void set_depth_packet_size(const depth_packet_size_control& val);
        void set_color_packet_size(const color_packet_size_control& val);
