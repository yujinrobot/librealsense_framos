...
#ifdef FRAMOS
        param_group<depth_inter_packet_delay_control>   depth_inter_packet_delay;
        param_group<color_inter_packet_delay_control>   color_inter_packet_delay;
        param_group<depth_packet_size_control>          depth_packet_size;
        param_group<color_packet_size_control>          color_packet_size;
#endif // FRAMOS
...
#ifdef FRAMOS
            depth_inter_packet_delay.vals[0] = other.depth_inter_packet_delay;
            color_inter_packet_delay.vals[0] = other.color_inter_packet_delay;
            depth_packet_size.vals[0] = other.depth_packet_size;
            color_packet_size.vals[0] = other.color_packet_size;
#endif // FRAMOS
        }
    };
...
#ifdef FRAMOS
        // FRAMOS sensor controls
        insert_control_to_map(map, p.depth_inter_packet_delay.vals[0].was_set, "controls-depth-inter-packet-delay", p.depth_inter_packet_delay, &depth_inter_packet_delay_control::depth_inter_packet_delay);
        insert_control_to_map(map, p.color_inter_packet_delay.vals[0].was_set, "controls-color-inter-packet-delay", p.color_inter_packet_delay, &color_inter_packet_delay_control::color_inter_packet_delay);
        insert_control_to_map(map, p.depth_packet_size.vals[0].was_set, "controls-depth-packet-size", p.depth_packet_size, &depth_packet_size_control::depth_packet_size);
        insert_control_to_map(map, p.color_packet_size.vals[0].was_set, "controls-color-packet-size", p.color_packet_size, &color_packet_size_control::color_packet_size);
#endif // FRAMOS
        return map;
    }
...
#ifdef FRAMOS
        update_preset_camera_control(in_preset.depth_inter_packet_delay     , p.depth_inter_packet_delay);
        update_preset_camera_control(in_preset.color_inter_packet_delay     , p.color_inter_packet_delay);
        update_preset_camera_control(in_preset.depth_packet_size            , p.depth_packet_size);
        update_preset_camera_control(in_preset.color_packet_size            , p.color_packet_size);
#endif // FRAMOS                                                  
    }
}
