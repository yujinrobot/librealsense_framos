...
namespace librealsense
{
    ...
    typedef struct depth_inter_packet_delay_control
    {
        int depth_inter_packet_delay;
        bool was_set = false;
    }depth_inter_packet_delay_control;

    typedef struct color_inter_packet_delay_control
    {
        int color_inter_packet_delay;
        bool was_set = false;
    }color_inter_packet_delay_control;

    typedef struct depth_packet_size_control
    {
        int depth_packet_size;
        bool was_set = false;
    }depth_packet_size_control;

    typedef struct color_packet_size_control
    {
        int color_packet_size;
        bool was_set = false;
    }color_packet_size_control;
...
#ifdef FRAMOS
        depth_inter_packet_delay_control depth_inter_packet_delay;
        color_inter_packet_delay_control color_inter_packet_delay;
        depth_packet_size_control        depth_packet_size;
        color_packet_size_control        color_packet_size;
#endif // FRAMOS
    };
