...
public:
    ...
    {
        #ifdef FRAMOS
            _devices_data = { _backend->query_uvc_devices(), _backend->query_usb_devices(), _backend->query_hid_devices(), _backend->query_cs_devices() };
        #else
    ...
    { 
        _is_stopped = !_active_object.is_active();
        return _is_stopped;
    };
#endif
