...
#endif
#ifdef FRAMOS
    syncer_process_unit::syncer_process_unit(std::initializer_list< bool_option::ptr > enable_opts, bool log, rs2_syncer_mode syncer_mode, std::vector<std::shared_ptr<matcher>> matchers)
        : processing_block("syncer"), _matcher((new timestamp_composite_matcher(matchers, syncer_mode)))
#endif
