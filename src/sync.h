...
namespace librealsense
{
    ...
    public:
#ifdef FRAMOS
        composite_matcher(std::vector<std::shared_ptr<matcher>> const& matchers, std::string const& name, rs2_syncer_mode syncer_mode = RS2_SYNCER_MODE_DEFAULT);
#endif
#ifndef FRAMOS
    ...
    public:
#ifdef FRAMOS
        composite_identity_matcher( std::vector< std::shared_ptr< matcher > > const & matchers, rs2_syncer_mode syncer_mode = RS2_SYNCER_MODE_DEFAULT);
#endif
#ifndef FRAMOS
    ...
    public:
        ...
        frame_number_composite_matcher(
            std::vector< std::shared_ptr< matcher > > const & matchers, rs2_syncer_mode syncer_mode = RS2_SYNCER_MODE_DEFAULT);
#endif
#ifndef FRAMOS
        frame_number_composite_matcher(
    ...
    public:
#ifdef FRAMOS
        timestamp_composite_matcher( std::vector< std::shared_ptr< matcher > > const & matchers, rs2_syncer_mode syncer_mode = RS2_SYNCER_MODE_DEFAULT);
#endif
#ifndef FRAMOS
